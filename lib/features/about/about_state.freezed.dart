...
class _$AboutStateImpl implements _AboutState {
  _$AboutStateImpl({this.loading = true, this.htmlContent = ''});
  ...
  @override
  String toString() {
    return 'AboutState(loading: $loading, htmlContent: $htmlContent)';
  }
...
abstract class _AboutState implements AboutState {
  factory _AboutState({final bool loading, final String htmlContent}) =
      _$AboutStateImpl;
